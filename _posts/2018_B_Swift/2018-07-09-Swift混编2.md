...
我们知道，每个文件的编译是独立的。<span style="color:red;">能够互相调用，就是在编译阶段就是能够找到对方声明的接口。</span>
...
```
InvocationDemo-Swift.h文件是在InvocationDemo.swiftmodule文件的基础上生成的。 也就是说现有swiftmodule文件再有-swift.h文件        
