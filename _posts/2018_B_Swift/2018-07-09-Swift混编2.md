...
Swift调用OC：<span style="color:red;font-weight:bold;">InvocationDemo-Bridging-Header.h</span>该文件是添加swift文件时会提示创建        
OC调用Swift：<span style="color:red;font-weight:bold;">InvocationDemo-Swift.h</span>该文件是编译过程中自动生成的,不需要手动创建          
OC调用OC：<span style="color:red;font-weight:bold;"头文件</span>   
Swift调用Swift：<span style="color:red;font-weight:bold;">swiftmodule</span>   
...
<span style="color:red;font-size:12;font-style:italic">说明：swift中 import 的作用是引入其它模块</span>
