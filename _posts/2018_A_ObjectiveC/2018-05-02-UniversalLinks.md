...
```text
<!-- a标签跳转 -->
<a href="https://xdf.fzzqft.com/redirectApp/xx">打开App</a>

<!-- JS 自动跳转 -->
<script>
function openApp() {
  window.location.href = "https://xdf.fzzqft.com/redirectApp/xx";
}
openApp();
</script>
```
...
<span style="color:red;">当H5页面的域名与universalLink的域名一样时，在h5页面唤起app会失效，会被认为是打开一个新页面<br>解决方案：<br>1、H5页面换域名<br>2、app端兼容Scheme唤起方式，H5通过Scheme的方式唤起</span>     
