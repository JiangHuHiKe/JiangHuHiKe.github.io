...
<span style="color:gray;font-style:italic;">运行dart代码</span>           
<span style="color:gray;font-style:italic;">布局：计算位置和大小生成绘制指令-cpu</span>            
<span style="color:gray;font-style:italic;">skia绘制：(坐标变换、栅格化)，完成绘制-gpu</span>       
